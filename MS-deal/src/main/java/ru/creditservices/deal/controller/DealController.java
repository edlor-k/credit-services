...
public class DealController{
    ...
    public ResponseEntity<Void> calculateFinalLoanParameters(
        ...
        log.info("Calculating final loan parameters for statementId: {}, with data: {}",
